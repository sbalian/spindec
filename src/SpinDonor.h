...
private:
  ...
  // basis states are also included)
  unsigned int orthogonal_upper_level_;
  unsigned int orthogonal_lower_level_;
  ...
  AdiabaticLabel orthogonal_label(AdiabaticLabel label) const;
